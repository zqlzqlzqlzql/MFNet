...
parser.add_argument('--dataset', choices=['Houston2013', 'Trento'], default='Houston2013', help='dataset to use')
...
parser.add_argument('--num_classes', default=15, help='dataset to use')
...
#         all_data_liDAR[i] = selectNeighboringPatch(padded_data_liDAR, PATCH_LENGTH, all_assign[i][0], all_assign[i][1])
#
# # Parameters
...
# for idx, value in zip(all_indices, y_all):
#     row, col = divmod(idx, width)
#     y_all_2d[row, col] = value
